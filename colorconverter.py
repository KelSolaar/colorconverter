...
COLOR_MODELS_TEMPLATES["ACES2065-1"] = {
    ...
    "ui_group": "rgb",
    "description": ("Used primarily in cinema for exchange of full fidelity images and "
...
COLOR_MODELS_TEMPLATES["ACEScc"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("Workspace for color correctors, target for ASC-CDL values created "
                    "on-set"),
    "illuminant": "ACES",
    "observer": "CIE 1931 2 Degree Standard Observer",
    "labels": ["Red", "Green", "Blue"],
...
COLOR_MODELS_TEMPLATES["ACEScct"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("Alternative workspace for color correctors, intended to be transient "
...
COLOR_MODELS_TEMPLATES["ACEScg"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("Workspace for painting/compositing applications that don't support "
...
COLOR_MODELS_TEMPLATES["ACESproxy"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("A lightweight encoding for transmission over HD-SDI (or other "
...
COLOR_MODELS_TEMPLATES["ARRI Wide Gamut 3"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("Based on virtual primaries optimized for the encoding of the color "
...
COLOR_MODELS_TEMPLATES["ARRI Wide Gamut 4"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("Sometimes referred to as LogC4, this space provides the encoding "
...
COLOR_MODELS_TEMPLATES["Adobe RGB (1998)"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("Originally defined to meet the demands for an RGB working space "
...
COLOR_MODELS_TEMPLATES["Adobe Wide Gamut RGB"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("Offers a large gamut by using pure spectral primary colors; covers "
...
COLOR_MODELS_TEMPLATES["Apple RGB"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("Describes the characteristics of a legacy Apple monitor, used for "
...
COLOR_MODELS_TEMPLATES["Best RGB"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("Almost identical to Don RGB 4 except for a modified red coordinate "
...
COLOR_MODELS_TEMPLATES["Beta RGB"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("Designed by Bruce Lindbloom as an optimized capture, archiving and "
...
COLOR_MODELS_TEMPLATES["Blackmagic Wide Gamut"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("A custom non-linear color space created by Blackmagic Design to "
...
COLOR_MODELS_TEMPLATES["CIE RGB"] = {
    ...
    "ui_group": "cie",
    "description": ("Created by the CIE in 1931, leveraging the results of a series of "
...
COLOR_MODELS_TEMPLATES["Cinema Gamut"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("Cinema Gamut is a set of primaries specified by Canon, typically "
...
COLOR_MODELS_TEMPLATES["ColorMatch RGB"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("A legacy space created by Radius to work with their PressView "
                    "displays"),
    "illuminant": "D50",
    "observer": "CIE 1931 2 Degree Standard Observer",
    "labels": ["Red", "Green", "Blue"],
...
COLOR_MODELS_TEMPLATES["DCDM XYZ"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("Digital Cinema Distribution Master [DCDM] was devised by Digital "
...
COLOR_MODELS_TEMPLATES["DCI-P3"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("First defined as part of the Digital Cinema Initiative in 2005 for "
...
COLOR_MODELS_TEMPLATES["DJI D-Gamut"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("Designed to encompass the capabilities of the DJI Zenmuse sensor, "
...
COLOR_MODELS_TEMPLATES["DRAGONcolor"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("Acts as a color engine that converts between the camera's native "
...
COLOR_MODELS_TEMPLATES["DaVinci Wide Gamut"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("DWG is designed to accommodate the vast majority of colors that can "
...
COLOR_MODELS_TEMPLATES["Display P3"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("Display P3 is a variant of the DCI-P3 color space, advanced by "
...
COLOR_MODELS_TEMPLATES["Don RGB 4"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("Wide gamut workspace with a 2.2 gamma. Captures the Ektachrome "
...
COLOR_MODELS_TEMPLATES["EBU Tech. 3213-E"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("In 1975, the European Broadcasting Union recommended this space for "
...
COLOR_MODELS_TEMPLATES["ECI RGB v2"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("The Metamorfoze Preservation Imaging Guidelines promotes use of "
...
COLOR_MODELS_TEMPLATES["ERIMM RGB"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("Extended Reference Input Medium Metric, intended to encode extended "
...
COLOR_MODELS_TEMPLATES["Ekta Space PS 5"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("Developed by Joseph Holmes for high quality storage of image data "
...
COLOR_MODELS_TEMPLATES["FilmLight E-Gamut"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("The gamut of this working space is designed to cover most colors "
...
COLOR_MODELS_TEMPLATES["ITU-R BT.2020"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("Often referred to simply as Rec.2020, this space provides parameter "
...
COLOR_MODELS_TEMPLATES["ITU-R BT.470 - 525"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("ITU-R BT.470 - 525 was recommended to define a standard for "
...
COLOR_MODELS_TEMPLATES["ITU-R BT.709"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("Standard developed by the ITU for image encoding and signal "
...
COLOR_MODELS_TEMPLATES["ITU-T H.273 - 22 Unspecified"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ('Recommendation ITU-T H.273 row 22 color space as given in Table 2 - '
...
COLOR_MODELS_TEMPLATES["ITU-T H.273 - Generic Film"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("Recommendation ITU-T H.273 Generic Film (color filters using "
...
COLOR_MODELS_TEMPLATES["Max RGB"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("A wide gamut color space with colors outside the xyY limits, "
...
COLOR_MODELS_TEMPLATES["NTSC (1953)"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("The original 1953 color NTSC specification, still part of the "
...
COLOR_MODELS_TEMPLATES["NTSC (1987)"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("In 1987, SMPTE adopted the SMPTE C (Conrac) phosphors for general "
...
COLOR_MODELS_TEMPLATES["PLASA ANSI E1.54"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("A standard codified by the Professional Lighting & Sound "
...
COLOR_MODELS_TEMPLATES["ProPhoto RGB"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("This space, invented by Kodak, offers an especially large gamut. "
...
COLOR_MODELS_TEMPLATES["RIMM RGB"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("Reference Input Medium Metric, intended to encode standard dynamic "
...
COLOR_MODELS_TEMPLATES["ROMM RGB"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("Reference Output Medium Metric RGB, invented by Kodak, offers an "
...
COLOR_MODELS_TEMPLATES["Russell RGB"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("Russell Cottrell extended Beta RGB into the cyans and blues to "
...
COLOR_MODELS_TEMPLATES["Xtreme RGB"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("Largest possible Adobe Photoshop-legal, tri-coordinate RGB space, "
                    "from HutchColor"),
    "illuminant": "D50",
    "observer": "CIE 1931 2 Degree Standard Observer",
    "labels": ["Red", "Green", "Blue"],
...
COLOR_MODELS_TEMPLATES["sRGB"] = {
    ...
    "section": "RGB Color Spaces",
    "ui_group": "rgb",
    "description": ("Microsoft and Hewlett-Packard designed sRGB in 1996 as a color "
...
COLOR_MODELS_TEMPLATES["cmy"] = {
    ...
    "ui_group": "rgb >",
    "description": ("Subtractive counterpart to RGB, where higher values get closer to "
...
COLOR_MODELS_TEMPLATES["hcl"] = {
    ...
    "section": "Derived from RGB",
    "ui_group": "rgb >",
    "description": ("HCL (Hue-Chroma-Luminance) or LCh refers to any of the cylindrical "
...
COLOR_MODELS_TEMPLATES["hsl"] = {
    ...
    "section": "Derived from RGB",
    "ui_group": "rgb >",
    "description": ("HSL models the way different paints mix together in the real world, "
...
COLOR_MODELS_TEMPLATES["hsv"] = {
    ...
    "section": "Derived from RGB",
    "ui_group": "rgb >",
    "description": ("Colors of each hue are arranged in a radial slice around a central "
...
COLOR_MODELS_TEMPLATES["hwb"] = {
    ...
    "section": "Derived from RGB",
    "ui_group": "rgb >",
    "description": ("Hue angle followed by the percentage of whiteness and percentage of "
                    "blackness"),
    "illuminant": "none",
    "observer": "CIE 1931 2 Degree Standard Observer",
...
COLOR_MODELS_TEMPLATES["prismatic"] = {
    ...
    "section": "Derived from RGB",
    "ui_group": "rgb >",
    "description": ("A simple transform of the RGB color cube into a light/dark "
...
COLOR_MODELS_TEMPLATES["rgbluminance"] = {
    ...
    "section": "Derived from RGB",
    "ui_group": "rgb >",
    "description": ("A photometric measure of the luminous intensity per unit area of "
...
COLOR_MODELS_TEMPLATES["ycbcr"] = {
    ...
    "section": "Derived from RGB",
    "ui_group": "rgb >",
    "description": ("Among a family of color spaces used as a part of the color pipeline "
...
COLOR_MODELS_TEMPLATES["yccbccrc"] = {
    ...
    "section": "Derived from RGB",
    "ui_group": "rgb >",
    "description": ("Specifically for use with ITU-R BT.2020 when adopting the constant "
...
COLOR_MODELS_TEMPLATES["ycocg"] = {
    ...
    "section": "Derived from RGB",
    "ui_group": "rgb >",
    "description": ("Formed from a simple transformation of an RGB space into a luma "
...
COLOR_MODELS_TEMPLATES["atd95"] = {
    ...
    "ui_group": "cam",
    "description": ("Achromatic (brightness), Tritanopic (redness-greenness), and "
...
COLOR_MODELS_TEMPLATES["cam02lcd"] = {
    ...
    "section": "Color Appearance Models",
    "ui_group": "cam",
    "description": ("CAM02-LCD is a version of CIECAM02 modified to fit Large Color "
...
COLOR_MODELS_TEMPLATES["cam02scd"] = {
    ...
    "section": "Color Appearance Models",
    "ui_group": "cam",
    "description": ("CAM02-SCD is a version of CIECAM02 modified to fit Small Color "
...
COLOR_MODELS_TEMPLATES["cam02ucs"] = {
    ...
    "section": "Color Appearance Models",
    "ui_group": "cam",
    "description": ("CAM02-UCS (Uniform Color Space) is a version of CIECAM02 modified "
...
COLOR_MODELS_TEMPLATES["cam16"] = {
    ...
    "section": "Color Appearance Models",
    "ui_group": "cam",
    "description": ("CAM16 was created as a successor to CIECAM02 to address CIECAM02's "
...
COLOR_MODELS_TEMPLATES["cam16lcd"] = {
    ...
    "section": "Color Appearance Models",
    "ui_group": "cam",
    "description": ("CAM16-LCD is a version of CAM16 attuned to fit Large Color "
...
COLOR_MODELS_TEMPLATES["cam16scd"] = {
    ...
    "section": "Color Appearance Models",
    "ui_group": "cam",
    "description": ("CAM16-SCD is a version of CAM16 attuned to fit Small Color "
...
COLOR_MODELS_TEMPLATES["cam16ucs"] = {
    ...
    "section": "Color Appearance Models",
    "ui_group": "cam",
    "description": ("CAM16-UCS is a version of CAM16 attuned to fit combined large and "
...
COLOR_MODELS_TEMPLATES["cct"] = {
    ...
    "section": "Qualities",
    "ui_group": "qua",
    "description": ("CCT is defined by the CIE as 'the temperature of the Planckian "
...
COLOR_MODELS_TEMPLATES["mired"] = {
    ...
    "section": "Qualities",
    "ui_group": "qua",
    "description": ("A mired (Micro Reciprocal Degree) is a unit used in photography and "
...
COLOR_MODELS_TEMPLATES["cielab"] = {
    ...
    "section": "CIE Fundamentals",
    "ui_group": "cie",
    "description": ("L* for perceptual lightness, a* for the magenta-green axis, and b* "
...
COLOR_MODELS_TEMPLATES["cieluv"] = {
    ...
    "section": "CIE Fundamentals",
    "ui_group": "cie",
    "description": ("A modification of CIEXYZ to display color differences more "
                    "conveniently"),
    "illuminant": "all",
    "observer": "all",
    "labels": ["Lightness", "Redness-greenness", "Yellowness-blueness"],
...
COLOR_MODELS_TEMPLATES["cieuvw"] = {
    ...
    "section": "CIE Fundamentals",
    "ui_group": "cie",
    "description": ("CIE 1964 U*V*W* color spcace, invented in 1964 to calculate color "
...
COLOR_MODELS_TEMPLATES["ciexyz"] = {
    ...
    "section": "CIE Fundamentals",
    "ui_group": "cie",
    "description": ("First attempt of a color space based on measurements of human "
...
COLOR_MODELS_TEMPLATES["clrpurity"] = {
    ...
    "ui_group": "dom",
    "description": ("A color's dominant wavelength is the wavelength of monochromatic "
...
COLOR_MODELS_TEMPLATES["hdrcielab"] = {
    ...
    "ui_group": "misc",
    "description": ("hdr-CIELAB was formulated by Fairchild and Chen (2011) to extend "
...
COLOR_MODELS_TEMPLATES["hdript"] = {
    ...
    "section": "Miscellaneous",
    "ui_group": "misc",
    "description": ("hdr-IPT was created by Fairchild et al. (2011) to extend the IPT "
...
COLOR_MODELS_TEMPLATES["ictcp_2100_1_hlg"] = {
    ...
    "section": "Miscellaneous",
    "ui_group": "misc",
    "description": ("Recommendation ITU-R BT.2100 HLG (Hybrid Log-Gamma); "
...
COLOR_MODELS_TEMPLATES["ictcp_2100_1_pq"] = {
    ...
    "section": "Miscellaneous",
    "ui_group": "misc",
    "description": ("Recommendation ITU-R BT.2100 PQ (Perceptual Quantizer); "
                    "IC<sub>T</sub>C<sub>P</sub> values for high dynamic range "
                    "television for use in production and international program "
                    "exchange"),
    "illuminant": "all",
...
COLOR_MODELS_TEMPLATES["llab"] = {
    ...
    "illuminant": "all",
    "observer": "CIE 1931 2 Degree Standard Observer",
    "defaults": ("Viewing Conditions: Reference samples and images, average surround, "
                 "subtending < 4"),
    "labels": [
...
COLOR_MODELS_TEMPLATES["munsell_clr"] = {
    ...
    "section": "Miscellaneous",
    "ui_group": "misc",
    "description": ("Devised in 1905 by Albert Munsell, the Munsell color system "
...
COLOR_MODELS_TEMPLATES["rlab"] = {
    ...
    "illuminant": "all",
    "observer": "CIE 1931 2 Degree Standard Observer",
    "defaults": ("Viewing Conditions: average; Discounting the "
...
COLOR_MODELS_TEMPLATES["whiteness_stensby"] = {
    ...
    "section": "Qualities",
    "ui_group": "qua",
    "description": ("Values larger than 100 indicate a bluish-white and values smaller "
...
COLOR_MODELS_TEMPLATES["whiteness_berger"] = {
    ...
    "section": "Qualities",
    "ui_group": "qua",
    "description": ("Indices larger than 33.33 indicate a bluish-white and values "
...
COLOR_MODELS_TEMPLATES["whiteness_cie"] = {
    ...
    "section": "Qualities",
    "ui_group": "qua",
    "description": ("W increases with whiteness, reaching 100 for the perfect diffuser. "
...
COLOR_MODELS_TEMPLATES["tintindex_cie"] = {
    ...
    "section": "Qualities",
    "ui_group": "qua",
    "description": ("A positive value indicates a greener tint, while a negative value "
...
COLOR_MODELS_TEMPLATES["yellowness_d1925"] = {
    ...
    "section": "Qualities",
    "ui_group": "qua",
    "description": ("ASTM D1925 was developed for the definition of the yellowness of "
...
COLOR_MODELS_TEMPLATES["yellowness_e313"] = {
    ...
    "section": "Qualities",
    "ui_group": "qua",
    "description": ("ASTM E313 has successfully been used for a variety of white or near "
...
COLOR_MODELS_TEMPLATES["yrg"] = {
    ...
    "section": "Miscellaneous",
    "ui_group": "misc",
    "description": ("A luminance-chroma space [Kirk, 2019] that fits well with visual "
...
COLOR_MODELS_TEMPLATES["pointer"] = {
    ...
    "section": "Miscellaneous",
    "ui_group": "misc",
    "description": ("States whether the associated CIEXYZ values are within Pointer’s "
...
COLOR_MODELS_TEMPLATES["macadam"] = {
    ...
    "section": "Miscellaneous",
    "ui_group": "misc",
    "description": ("States whether the associated xyY values are within MacAdam limits "
...
COLOR_MODELS_TEMPLATES["cri"] = {
    ...
    "section": "Light Source Quality",
    "ui_group": "spd",
    "description": ("Color Rendering Index is a quantitative measure of the ability of a "
...
COLOR_MODELS_TEMPLATES["cfi"] = {
    ...
    "section": "Light Source Quality",
    "ui_group": "spd",
    "description": ("The general Color Fidelity Index represents how closely the color "
...
COLOR_MODELS_TEMPLATES["cqs"] = {
    ...
    "section": "Light Source Quality",
    "ui_group": "spd",
    "description": ("Color Quality Scale, a quantitative measure of the ability of a "
...
COLOR_MODELS_TEMPLATES["lum_efficacy"] = {
    ...
    "section": "Light Source Quality",
    "ui_group": "spd",
    "description": ("The quotient of luminous flux divided by the total radiant flux, "
...
COLOR_MODELS_TEMPLATES["lum_efficiency"] = {
    ...
    "section": "Light Source Quality",
    "ui_group": "spd",
    "description": ("The ratio of the total luminous flux to the total radiant flux of "
...
COLOR_MODELS_TEMPLATES["lum_flux"] = {
    ...
    "section": "Light Source Quality",
    "ui_group": "spd",
    "description": ("The time rate of flow of radiant energy, evaluated in terms of "
...
COLOR_MODELS_TEMPLATES["sr_sd"] = {
    ...
    "ui_group": "spd",
    "description": ("Recovered the spectral distribution and adapted to CIEXYZ D65 values "
...
def parse_arguments():
    ...
    parser.add_argument(
        "--plotpath",
        type=str,
        help=("Output spectral plot path; plot is not saved if argument is omitted. "
    ...
    ciexyz.add_argument(
        "--z_val",
        type=float,
        help=("Z value, similar to Blue in CIERGB, solely made up of the S cone "
              "response, 0-1"),
    )
    ...
    spectrum.add_argument(
        ...
        nargs="+",
        type=float,
        help=("List of decimal values (preferrably to 6+ places), with spaces in "
    ...
    spectrum.add_argument(
        "--tm30path",
        type=str,
        help=("Path and filename for IES TM-30 Color Rendition Report; actual or "
...
def result(
    ...
    if use_space_separated and (isinstance(value) == list or isinstance(value) == np.ndarray):
